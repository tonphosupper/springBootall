...
import com.springboot.customer.model.repository.CustomerRepository;
...
public class CustomerController {
	...
	public Customer postCustomer(@RequestBody Customer customer) {		
		Customer _customer = customerRepository.save(new Customer(customer.getName(), customer.getAge(), customer.getActive()));
		return _customer;
	}
